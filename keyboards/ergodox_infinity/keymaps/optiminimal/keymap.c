...
// dfu-util --list
// dfu-util --device 1c11:b007 -D .build/ergodox_infinity_optiminimal.bin
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
/* Keymap 0: Basic layer
 *
 * ,--------------------------------------------------.           ,--------------------------------------------------.
 * | ESC    |   1  |   2  |   3  |   4  |   5  | PLAY |           | RIGHT|   6  |   7  |   8  |   9  |   0  |   -    |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |Grv   |LCTRL | LGUI | LALT |  NO  |                                       | Left | Down | Up   |Right | NO   |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        | MPrev|Vol-  |       | Vol+ | MNext|
 *                                 ,------|------|------|       |------+--------+------.
 *                                 |      |      | Home |       | PgUp |        |      |
 *                                 | Back |LShift|------|       |------|Enter   |Space |
 *                                 | space|      | End  |       | PgDn |        |      |
 *                                 `--------------------'       `----------------------'
 */
...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        KC_LSFT,        KC_Z,         KC_X,    KC_C,     KC_V,   KC_B,   LT(SYMB,KC_B),
        KC_GRV,         KC_LCTRL,     KC_LGUI, KC_LGUI,  KC_LALT,
                                                         KC_MPRV,KC_VOLU,
                                                                 KC_HOME,
        ...
        // right hand
             ...
             KC_RGUI,     KC_N,   KC_M,    KC_COMM, KC_DOT, KC_SLSH,          KC_EQL,
...
[SYMB] = KEYMAP(
       ...
       XXXXXXX,RESET,  KC_AT,  KC_LCBR,KC_RCBR,KC_PIPE,_______,
