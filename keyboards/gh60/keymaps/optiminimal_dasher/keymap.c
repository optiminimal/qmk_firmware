...
[_FL] = { /* Layer 3: Functions */
    ...
    {KC_CAPS, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_UP,   XXXXXXX, _______},
    {_______, _______, _______, XXXXXXX, XXXXXXX, KC_MPLY, XXXXXXX, XXXXXXX, _______, _______, KC_LEFT, KC_DOWN, KC_RGHT, _______}
  }
